---
{"dg-publish":true,"permalink":"/latex-suite/"}
---

This is the plugin I mainly use to accelerate writing out LaTex code.
...
![visual_snippets.gif|1000](/img/user/Vault%20Utilities/_media/visual_snippets.gif)

# Snippets
```json
[
    //Calculus
    { trigger: "eval", replacement: "\\bigg\\rvert_${0:{x}}", options: "mA" },
   ...
   // { trigger: "dd", replacement: "\\mathrm{d}", options: "mA" },
    ...
    { trigger: "remark", replacement: "**Remark.** $0\n <span style='float:right;'>$\\blacklozenge$</span>", options: "t" },
    ...
    // color
    {trigger: "red", replacement: "\\textcolor{red}{$0}", options: "mA"},
	...
	{trigger: "lim", replacement: "\\lim_{ ${0:(x,y)} \\to ${1:\\infty} } $2", options: "mA"},

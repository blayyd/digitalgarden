...
> 4. Derive a set of coupled [[Differential Equations/Differential Equations\|Differential Equations]] to model the motion of masses in the system. 
> 5. Transform the coupled or[](Differential%20Equations.md) from step 4 into a standard eigenvalue problem (SEP) by creative use of matrices.

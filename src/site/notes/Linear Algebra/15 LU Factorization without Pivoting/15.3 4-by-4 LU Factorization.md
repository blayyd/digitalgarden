...
<iframe src="/img/user/Vault%20Utilities/_media/4x4_LU_Factorization.pdf" width="100%" height="900px" title="4x4_LU_Factorization.pdf" style="border:1px solid #ccc;"></iframe>
`\end{proof}`